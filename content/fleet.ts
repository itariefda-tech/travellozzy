...
export const fleet: Vehicle[] = [
  ...
  { id: 'denza', slug: 'denza', brand: 'Denza', model: '', name: 'Denza', category: 'premium', priceMode: 'quote', image: '/images/fleet/denza.webp', imageAlt: 'Denza', recommendedFor: ['Wedding', 'Luxury', 'Corporate'], isFeatured: false },
