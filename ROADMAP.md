...
- [x] Map 15 supplied vehicle images to matching fleet entries and optimize them as gallery WebP assets.
- [x] Keep generic editorial placeholders for Mercedes-Benz C300, Innova Zenix Q, and Toyota Veloz because no matching image was supplied.
